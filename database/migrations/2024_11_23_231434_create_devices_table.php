...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('devices', function (Blueprint $table) {
            $table->id()->comment('Primary key of the devices table');
            ...
            $table->foreign('department_id')->references('id')->on('departments')->onDelete('set null')->comment('References the departments table');
