...
class VacationRequestApproved implements EmailTemplateDefinition
{
    ...
    {
        return 'Sent to the employee when their vacation request has been approved by their manager.';
    }
    ...
    public static function getAvailableVariables(): array
    {
        return [
            ...
            'vacation_requests.review_notes' => ['label' => 'Reviewer Notes', 'example' => 'Enjoy your time off!'],
...
{{#vacation_requests.review_notes}}
**Reviewer Notes:** {{vacation_requests.review_notes}}
{{/vacation_requests.review_notes}}

Your time off has been added to the calendar. Enjoy your time off!
...
BODY;
    ...
    public static function getSampleData(): array
    {
        return [
            ...
            'vacation_requests.review_notes' => 'Enjoy your time off!',
