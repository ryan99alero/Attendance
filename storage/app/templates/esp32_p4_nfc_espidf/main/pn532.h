 ...
 * @param io_handle PN532 io handle
 * @param maxRetries 0x00 - only one try, 0xFF - try for ever, 0x01..0xFE -
 * number of retries
 * @return ESP_OK if successful
 */
 ...
 * @param io_handle PN532 io handle
 * @param baud_rate_and_card_type baud rate and type, use PN532_BRTY_xxx
 * defines.
 * @param uid buffer to receive the UID bytes (UIDs can be 4 bytes, 7 bytes or
 * 10 bytes long)
