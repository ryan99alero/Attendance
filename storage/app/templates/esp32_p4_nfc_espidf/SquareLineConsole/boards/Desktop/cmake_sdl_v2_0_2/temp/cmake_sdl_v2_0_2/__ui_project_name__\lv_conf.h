/**
 * @file lv_conf.h
 * Configuration file for v9.1.0, v9.2.2
 */
...
#endif*/
#define LV_SQUARELINE_MOD__SWIPE 1  //if defined or 1, reverts back to LVGL8.3 swipe-gesture behaviour (LVGL-9.1 abandons swipe too early if it finds/leaves a new object in the swipe-path, 9.2.2 seems to have this fixed/reverted)
...
#define LV_COLOR_DEPTH __UI_PROJECT_COLOR_DEPTH__  //16  //(LV_COLOR_16_SWAP is abandoned by LVGL9, but lv_draw_sw_rgb565_swap() can be added to display flush function)
...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (64U * 1024U * 1024U)  //(64 * 1024U)          /*[bytes]*/
...
#define LV_DRAW_LAYER_SIMPLE_BUF_SIZE    (1024 * 1024) //(24 * 1024)   /*[bytes]*/
...
#define LV_USE_PXP 0
#define LV_USE_DRAW_PXP LV_USE_PXP //0

#if LV_USE_PXP //#if LV_USE_DRAW_PXP
    /* Use PXP for drawing.*/
...
#define LV_USE_ASSERT_STYLE         1 //0   /*Check if the styles are properly initialized. (Very fast, recommended)*/
...
#define LV_USE_PRIVATE_API      0 //1 //0 //Tried to avoid exposing private APIs (gen_mpy.py was rewritten for this) but without it SLS had issue with event-callback settings, so enabled it in the end
...
#define LV_USE_BIDI 0 //1 //0  //if enabled, might give a warning about an uninitialized length variable in lv_label.c
#if LV_USE_BIDI
...
#define LV_USE_ARABIC_PERSIAN_CHARS 1 //0
...
#define LV_USE_LODEPNG 1 //0

/*PNG decoder(libpng) library*/
#define LV_USE_LIBPNG 0

/*BMP decoder library*/
#define LV_USE_BMP 1 //0

/* JPG + split JPG decoder library.
 * Split JPG is a custom format optimized for embedded systems. */
#define LV_USE_TJPGD 1 //0
...
#define LV_USE_SYSMON   1 //0
    ...
    #define LV_USE_PERF_MONITOR 1 //0
...
#define LV_DISPLAY_ROT_MAX_BUF (1000*1024) //(10*1024)  //needed by SLS?
